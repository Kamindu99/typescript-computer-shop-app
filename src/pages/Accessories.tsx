...
function Accessories({ }: Props) {
    ...
    const Accessories = [
        ...
        },
        {
            ...
            name: "16GB Pendrive",
            price: 3000,
            description: " Pendrive 16GB USB 2.0 Flash Drive Thumb Drive Jump Drive Memory Drive with LED Light for Storage and Backup (5 Mixed Colors: Black Blue Green Red Silver)",
                                    ...
                                    <div className="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row">
                                        ...
                                        <div className="media-body" style={{ textAlign: "left" }}>
                                            ...
                                            <ul className="list-inline list-inline-dotted mb-0">
                                                <li className="list-inline-item">All items from <a href="#" data-abc="true">DotCom Computers</a></li>
